...
export function HeroSection() {
  return (
    <div
      className="flex min-h-[480px] flex-col items-center justify-center gap-8 rounded-2xl bg-cover bg-center bg-no-repeat p-8 md:min-h-[540px] md:p-12"
      style={{
        backgroundImage:
    ...
    >
      <div className="flex max-w-3xl flex-col gap-4 text-center">
        <h1 className="text-on-primary text-4xl leading-tight font-black tracking-[-0.04em] md:text-6xl">
      ...
      <div className="mt-2 flex flex-wrap justify-center gap-4">
        ...
        <Link
          href="/feed"
          className="bg-surface-container-high text-on-primary-fixed-variant flex min-w-[140px] cursor-pointer items-center justify-center overflow-hidden rounded-xl px-6 py-3.5 text-base leading-normal font-bold tracking-[0.015em] transition-transform hover:-translate-y-1"
        >

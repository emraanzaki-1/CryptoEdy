          ...
          <article className="space-y-24 lg:col-span-9">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="bg-primary text-on-primary shadow-primary/10 rounded-xl p-8 shadow-xl">
                  ...
                  <p className="text-sm leading-relaxed opacity-90">
                    ...
                    Service (e.g., payment processing, email delivery, analytics). These providers
            ...
            <section id="cookies" className="scroll-mt-32">
                  ...
                  <tbody className="divide-outline-variant/10 divide-y">
                    <tr>
                      ...
                      <td className="text-on-surface-variant px-6 py-6 text-sm leading-relaxed">
                        Maintaining secure session states and authentication tokens. Required for
                    ...
                    <tr>
                      ...
                      <td className="text-on-surface-variant px-6 py-6 text-sm leading-relaxed">
                        Remembering your settings such as theme, notification preferences, and
              ...
              <p className="text-on-surface-variant mt-4 text-sm">
                You can manage cookie settings through your browser. Disabling cookies may affect
            ...
            <section id="rights" className="scroll-mt-32">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <div className="bg-surface-container-low rounded-xl p-6">
                  ...
                  <p className="text-on-surface-variant text-xs">
                    Correct inaccurate or incomplete personal information associated with your
                    account at any time.
                  </p>
                </div>
                <div className="bg-surface-container-low rounded-xl p-6">
                  ...
                  <p className="text-on-surface-variant text-xs">
                    Request deletion of your account and all associated personal data. We retain
                    data only as long as your account is active or as legally required.
                  </p>
                </div>
              </div>
              <p className="text-on-surface-variant mt-6 text-sm leading-relaxed">
                ...
                collect personal information from children. Your information may be transferred

...
export default function TermsPage() {
  return (
    <div className="bg-surface relative flex min-h-screen w-full flex-col overflow-x-clip">
      ...
      <main className="mx-auto w-full max-w-[1200px] flex-1 px-4 pt-16 pb-24 md:px-8">
        {/* ── Hero Header ── */}
        <header className="mb-20">
          ...
          <h1 className="text-headline-lg text-on-surface mb-8 max-w-4xl font-black">
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-12">
          ...
          <article className="space-y-24 lg:col-span-9">
            ...
            <section id="intro" className="scroll-mt-32">
              <h2 className="text-headline text-on-surface mb-8 flex items-baseline gap-4 font-black">
                <span className="text-primary/30 text-headline-md italic">01</span>
                Introduction
              </h2>
              <div className="bg-surface-container-lowest rounded-xl p-8 shadow-[0_32px_64px_-12px_rgba(11,28,48,0.06)] md:p-10">
                <div className="text-on-surface-variant space-y-6 leading-relaxed">
                  <p>
                    ...
                    intelligence. By accessing our proprietary data, analysis, and research tools,
                    you agree to be bound by these Terms of Service.
                  </p>
                  <p>
                    Our mission is to provide high-end editorial insight into the digital asset
                    markets. These terms are designed to ensure the integrity of our research and
                    the security of our community. If you do not agree, you may not use the Service.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="subscription" className="scroll-mt-32">
              ...
              <div className="bg-inverse-surface text-inverse-on-surface relative overflow-hidden rounded-xl p-8 shadow-2xl md:p-12">
                <div className="relative z-10">
                  <div className="mb-10 flex flex-col items-start justify-between gap-8 border-b border-white/10 pb-10 md:flex-row md:items-center">
                    <div>
                      <h3 className="text-headline mb-2 font-black">Premium Research Access</h3>
                  ...
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                    <div className="space-y-4">
                      <h4 className="text-primary-fixed text-overline font-black tracking-[0.05em] uppercase">
                        Billing
                      </h4>
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-inverse-on-surface/80 text-sm leading-relaxed">
                        You may cancel at any time, and your access will continue until the end of
                        the current billing period. No partial refunds are provided.
                      </p>
                    </div>
                    <div className="space-y-4">
                      <h4 className="text-primary-fixed text-overline font-black tracking-[0.05em] uppercase">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <p className="text-sm font-bold">No Commercial Redistribution</p>
                    </div>
                    <div className="flex items-center gap-4">
                      <CircleX className="text-error size-5 shrink-0" />
                      <p className="text-sm font-bold">No AI Training Scraping</p>
                    </div>
                    <div className="flex items-center gap-4">
                      <CircleCheck className="text-secondary size-5 shrink-0" />
                      <p className="text-sm font-bold">Limited Individual Citation Allowed</p>
                    </div>
                  </div>
                </div>
            ...
            <section id="liability" className="scroll-mt-32">
              ...
              <div className="bg-error-container rounded-xl p-8 md:p-10">
                <div className="flex items-start gap-6">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-on-error-container text-xl font-black tracking-[-0.04em] uppercase">
                    ...
                    <p className="text-on-error-container leading-relaxed">
                      ...
                      educational purposes only and does not constitute financial, investment,
                      legal, or tax advice. Cryptocurrencies are highly volatile, and past
                      performance is not indicative of future results.
                    </p>
                    <p className="text-on-error-container/70 text-sm italic">
